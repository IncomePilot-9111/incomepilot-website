  ...
  return (
    <div className="min-h-screen bg-[#070F15] flex flex-col">
      ...
      <div
        ...
        style={{
          background: 'radial-gradient(ellipse 70% 50% at 50% -10%, rgba(61,214,176,0.13) 0%, transparent 65%)',
        }}
      />
      <div
        aria-hidden="true"
      ...
      <main className="relative z-10 flex-1 flex items-center justify-center px-5 py-10">
        <div className="w-full max-w-sm">
          ...
          <p className="text-center text-xs text-[#2E5060] mt-6 leading-relaxed px-4">
            ...
            <Link href="/terms" className="hover:text-[#3DD6B0] transition-colors underline underline-offset-2">
              Terms of Use
            </Link>{' '}
            and{' '}
